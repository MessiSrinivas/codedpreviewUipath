...
namespace DecodeTest
{
    public class WorkflowRunnerService
    {
        ...
        /// <summary>
        /// Invokes the TestData.cs
        /// </summary>
        public void TestData()
        {
            var result = _runWorkflowHandler(@"TestData.cs", new Dictionary<string, object>{}, default, default, default);
        }

        /// <summary>
        /// Invokes the AdactinLogIn.cs
        /// </summary>
        public void AdactinLogIn()
        {
            var result = _runWorkflowHandler(@"AdactinLogIn.cs", new Dictionary<string, object>{}, default, default, default);
        }
    }
}